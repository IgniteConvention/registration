...
function App() {
  ...
  const availableEvents = {
    ...
    "Music Division (Performance)": [
      ...
      "Male Solo Piano", "Female Solo Piano", "Freestyle Male Piano", "Freestyle Female Piano Solo",
      "Duet Piano", "Solo Woodwind", "Solo String Plucked", "Solo String Powered", "Solo Brass",
      "Solo Freestyle Guitar Male", "Solo Freestyle Guitar Female", "Duet Instrumental",
      "Trio Instrumental", "Quartet Instrumental", "Instrumental Ensemble", "Solo Miscellaneous"
    ],
    "Athletics (Male)": [
    ...
    "Athletics (Female)": [
      "100 Meter Dash", "200 Meter Dash", "400 Meter Dash", "800 Meter Run", 
      "1600 Meter Run", "400 Meter Relay", "1600 Meter Relay", "Soccer Kick", 
      "Physical Fitness", "Table Tennis", "Volleyball", "Archery - Compound Bow", 
      "Archery - Traditional Instinctive", "Archery - Limited Freestyle", 
    ...
    "Dramatic Arts Division (Performance)": [
      ...
      "Preaching (F) 16-18", "Illustrated Storytelling Male", "Illustrated Storytelling Female", 
      "Puppets", "Sign Language Team (5-10)", "Sign Language Team (11-20)", 
      "One Act Play"
    ],
